...
20 subportals return REAL RECORDS via native API/scrape; the rest return a SEARCH GUIDE with native cercador URL.
NATIVE-HANDLER SUBPORTALS (real records, citable):
  ...
  • Europeana API: catalonica:mnac (art), catalonica:arca (~229K Catalan historical press), catalonica:cartoteca (historical maps ICGC), catalonica:regira (~51K Girona patrimoni), catalonica:dugidocs (~18K UdG repo)
...
SEARCH-GUIDE SUBPORTALS (URLs + topic hints, no records — direct the user to search_url_native, do NOT fabricate records):
  catalonica:hcc, reus, iei, trencadis, corpusliterari, arxiuparaula, bipadi, rde, rd_tecnocampus, drac, maco, dugife, dugimedia, rcub, egranados, p3d, bilderatlas, ddduabrecursosdocents, ddduabv2
